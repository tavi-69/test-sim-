...
static void create_10_teams () {
    ...
    Player mihai{ "Ionescu Mihai", 18, "CAM", "Romania" };
    mihai.update_team("Romania");
    Romania.add_player(mihai);

    Player andrei{ "Popescu Andrei", 19, "ST", "Romania" };
    andrei.update_team("Romania");
    Romania.add_player(andrei);

    Player cristian{ "Georgescu Cristian", 20, "CDM", "Romania" };
    cristian.update_team("Romania");
    Romania.add_player(cristian);

    Player radu{ "Dumitrescu Radu", 18, "CB", "Romania" };
    radu.update_team("Romania");
    Romania.add_player(radu);
